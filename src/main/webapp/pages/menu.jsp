        ...
        <div class="navbar navbar-inverse">
                ...
                <table class="style-color" border="1px">
                    ...
                    <c:forEach items="${allMenu}" var="menu">
                        <tr>
                            <td>${menu.getName()} <a href="/restaurant/menudetails/${menu.getId()}">Подробнее</a> <a href="/restaurant/menudelete/${menu.getId()}">удалить это меню</a> <a href="/restaurant/editmenu/${menu.getId()}">Редактировать</a></td> 
                        </tr>
                    </c:forEach>
                </table>
                <h3><a href="/restaurant/addmenu/${menu.getId()}">Добавить новое меню</a></h3>
            </div>
        </center>  
    </body>
</html>    