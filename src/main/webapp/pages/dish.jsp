...
<html>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
                ...
                <h1 class="style-color">Список блюд:</h1>
                <table class="style-color" border="1px">
                    ...
                    <c:forEach items="${allDishes}" var="dish">
                        <tr>
                            ...
                            <td>${dish.getWeight()} <a href="/restaurant/dishdetails/${dish.getId()}">Подробнее</a> <a href="/restaurant/dishdelete/${dish.getId()}">удалить это блюдо</a> <a href="/restaurant/editdish/${dish.getId()}">Редактировать</a></td>
                            
                        </tr>
                    </c:forEach>
                </table>
                <h3><a href="/restaurant/adddish/${dish.getId()}">Добавить новое блюдо</a></h3>
            </div>
        </center>
    </body>
</html>    